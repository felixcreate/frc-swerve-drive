...
public class RobotContainer {
    ...
    m_robotDrive.setDefaultCommand(
        ...
        new RunCommand(
            () -> m_robotDrive.drive(
                ...
                -MathUtil.applyDeadband(m_driverController.getRawAxis(4)*0.5, OIConstants.kDriveDeadband),
                true, true),
            m_robotDrive));
  }
  ...
  public Command getAutonomousCommand() {
    ...
    Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(List.of(
        ...
        new Pose2d(new Translation2d(2, -1), new Rotation2d(0)),
        new Pose2d(new Translation2d(4, 0), new Rotation2d(0)),
        new Pose2d(new Translation2d(2, 1), new Rotation2d(0)),
        new Pose2d(new Translation2d(0, 0), new Rotation2d(0))
        ), config);
